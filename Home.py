...
with st.container():
    ...
    with st.sidebar:
        ...
        """<a href="mailto:haripriya04raj@gmail.com" class="text-decoration-none text-dark"><i class="fas fa-envelope contact-icons1" style="font-size: 30px;"></i></a>""",unsafe_allow_html=True,)
        columns[i:=i+1].markdown("""
        <a href="tel:9095054595" class="text-decoration-none text-dark"><i class="fa fa-phone-alt" style="font-size: 30px;"></i></a>""",unsafe_allow_html=True,)
        columns[i:=i+1].markdown("""
        <a href="https://github.com/hari04hp" class="text-decoration-none text-dark"><i class="fab fa-github contact-icons1" style="font-size: 30px;"></i></a>""",unsafe_allow_html=True,)
        columns[i:=i+1].markdown("""
        <a href="https://www.linkedin.com/in/haripriyar" class="text-decoration-none text-dark"><i class="fab fa-linkedin contact-icons1" style="font-size: 30px;"></i></a>""",unsafe_allow_html=True,)
...
with st.container():
    ...
    with st.expander("See experience"):
        ...
        with tab1:
            st.write("""
                    - Developed the core production risk model with all the loans resulting a KS of about 30. This was implemented into production and was expected 10% increase in loans volume and 8% reduction in risk.
...
with st.container():
    ...
    # with columns[0]:
    #     with st.container():
    #         st.subheader("Case study - cyclistic bike share analysis")
    #         st.write("""For Google Data Analytics Course, I have completed the case study on a fictional company Cyclistic on maximizing the number of annual memberships. The Case Study is published in RPubs, Kaggle and github.""")
    # st.markdown("""<img src='data:image/png;base64,{}' class="card-img-top"/> """.format(
    #   img_to_bytes("images/cyclistic-bike-share.png")
    # ),unsafe_allow_html=True)
